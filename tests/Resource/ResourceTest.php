...
class ResourceTest extends \WP_UnitTestCase {
	...
	public function test_zero_decimals(): void {
		self::assertSame( 10000, Resource::currency_to_unit_amount( '100' ) );
		self::assertSame( 5000, Resource::currency_to_unit_amount( '50' ) );
		self::assertSame( 250000, Resource::currency_to_unit_amount( '2500' ) );
	}
	...
	public function test_two_decimals(): void {
		self::assertSame( 10000, Resource::currency_to_unit_amount( '100.00' ) );
		self::assertSame( 10099, Resource::currency_to_unit_amount( '100.99' ) );
		self::assertSame( 10001, Resource::currency_to_unit_amount( '100.01' ) );
		self::assertSame( 12345, Resource::currency_to_unit_amount( '123.45' ) );
	}
	...
	public function test_one_decimal(): void {
		self::assertSame( 10050, Resource::currency_to_unit_amount( '100.5' ) );
		self::assertSame( 10090, Resource::currency_to_unit_amount( '100.9' ) );
		self::assertSame( 10010, Resource::currency_to_unit_amount( '100.1' ) );
	}
	...
	public function test_four_decimals_truncates(): void {
		self::assertSame( 10012, Resource::currency_to_unit_amount( '100.1234' ) );
		self::assertSame( 10099, Resource::currency_to_unit_amount( '100.9999' ) );
		self::assertSame( 10056, Resource::currency_to_unit_amount( '100.5678' ) );
	}
	...
	public function test_thousand_separators(): void {
		self::assertSame( 100000, Resource::currency_to_unit_amount( '1,000.00' ) );
		self::assertSame( 1000000, Resource::currency_to_unit_amount( '10,000' ) );
		self::assertSame( 123456789, Resource::currency_to_unit_amount( '1,234,567.89' ) );
		self::assertSame( 1050, Resource::currency_to_unit_amount( '10.50' ) );
	}
	...
	public function test_currency_symbols(): void {
		self::assertSame( 10000, Resource::currency_to_unit_amount( '$100.00' ) );
		self::assertSame( 10000, Resource::currency_to_unit_amount( '$ 100.00' ) );
		self::assertSame( 10050, Resource::currency_to_unit_amount( '$100.50' ) );
	}
	...
	public function test_integer_input(): void {
		self::assertSame( 10000, Resource::currency_to_unit_amount( 100 ) );
		self::assertSame( 5000, Resource::currency_to_unit_amount( 50 ) );
		self::assertSame( 100, Resource::currency_to_unit_amount( 1 ) );
	}
	...
	public function test_zero_values(): void {
		self::assertSame( 0, Resource::currency_to_unit_amount( '0' ) );
		self::assertSame( 0, Resource::currency_to_unit_amount( '0.00' ) );
		self::assertSame( 0, Resource::currency_to_unit_amount( 0 ) );
		self::assertSame( 0, Resource::currency_to_unit_amount( 0.00 ) );
	}
	...
	public function test_empty_string(): void {
		self::assertSame( 0, Resource::currency_to_unit_amount( '' ) );
	}
	...
	public function test_small_values(): void {
		self::assertSame( 1, Resource::currency_to_unit_amount( '0.01' ) );
		self::assertSame( 99, Resource::currency_to_unit_amount( '0.99' ) );
		self::assertSame( 50, Resource::currency_to_unit_amount( '0.50' ) );
		self::assertSame( 5, Resource::currency_to_unit_amount( '0.05' ) );
	}
	...
	public function test_large_values(): void {
		self::assertSame( 99999999, Resource::currency_to_unit_amount( '999999.99' ) );
		self::assertSame( 100000000, Resource::currency_to_unit_amount( '1000000.00' ) );
		self::assertSame( 100000000, Resource::currency_to_unit_amount( '1,000,000' ) );
	}
